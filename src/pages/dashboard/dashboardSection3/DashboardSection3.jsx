...
import "./style.css"
import DashboardSection4 from '../dashboardSection4/DashboardSection4'

function DashboardSection3() {
    return (
        <div className="dashboardSection3ContainerParent">

            <div className="dashboardSection3Container">
                <div className="dashboardSection3Box1">
                    <div className="dashboardSection3Box1Text">Order ID</div>
                </div>
                <div className="dashboardSection3Box1">
                    <div className="dashboardSection3Box1Text">Order date</div>
                    <svg className='dashboardSection3Box1Icon' xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
                ...
                <div className="dashboardSection3Box1 dashboardSection3Box1Alter">
                    <div className="dashboardSection3Box1Text">Order amount</div>
                </div>
                <div className="dashboardSection3Box1 dashboardSection3Box1Alter">
                    <svg className='dashboardSection3Box1Icon dashboardSection3Box1IconDot' xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                    ...
                    <div className="dashboardSection3Box1Text">Transaction Fees</div>
                </div>
            </div>

            {

                [...Array(19)].map((value, index) => {
                    return (
                        <DashboardSection4 />
                    )
                })
