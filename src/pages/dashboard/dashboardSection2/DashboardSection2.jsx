...
function DashboardSection2() {
    return (
        <div className="dashboardSection2Container">
            <div className="dashboardSection2Text">Transactions | This Month</div>

            <div className="dashboardSection2Table">

                <div className="dashboardSection2TableBox1">
                    <div className="dashboardSection2TableBox1Section">
                        <svg className='dashboardSection2TableBox1SectionIcon' xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <g clip-path="url(#clip0_17601_3685)">
                            ...
                            <defs>
                                <clipPath id="clip0_17601_3685">
                                    <rect width="14" height="14" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
                        <div className="dashboardSection2TableBox1SectionText">Search by order ID...</div>
                    </div>
                </div>

                <div className="dashboardSection2TableBox1Section2">
                    <div className="dashboardSection2TableBox1Section2Box1">
                        <div className="dashboardSection2TableBox1Section2Box1Text">Sort</div>
                        <svg className='dashboardSection2TableBox1Section2Box1Icon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <div className="dashboardSection2TableBox1Section2Box2">
                        <svg className='dashboardSection2TableBox1Section2Box2Icon' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
